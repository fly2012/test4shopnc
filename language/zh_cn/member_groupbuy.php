...
$lang['groupbuy_price_tip'] = '团购价格为该商品参加活动时的促销价格<br/>必须是0.01~1000000之间的数字(单位：个)<br/>团购价格应包含邮费，团购商品系统默认不收取邮费';
...
$lang['group_pic_explain'] = '用于团购活动页面展示的图片,支持jpg、jpeg、gif、png格式上传<br/>建议选择尺寸480x350、大小1M内的图片';
